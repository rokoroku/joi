...
Note that if you want to intercept errors on objects, you will get a nested structure to explore the children errors, located at each error level on `err.context.reason`.
