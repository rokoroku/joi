...
module.exports = internals.Any = class {
    ...
    _createOverrideError(type, context, state, options, message, template) {
        ...
        const finish = () => {
            ...
            if (errors.length && typeof this._flags.error === 'function') {
                ...
                if (typeof change === 'string') {
                    errors = [this._createOverrideError('override', { reason: errors }, state, options, change)];
                }
                else {
                    errors = [].concat(change)
                        .map((err) => {
                            ...
                            return err instanceof Error ?
                                err :
                                this._createOverrideError(err.type || 'override', err.context, state, options, err.message, err.template);
                        });
                }
            }
